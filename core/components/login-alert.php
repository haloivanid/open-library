<?php
  ...
  '<div class="flex items-center p-4 mb-24 bg-red-100 rounded-lg dark:bg-red-200 bg-opacity-75 animate-bounce">' .
  ...
  '<span class="ml-3 text-base font-medium text-red-700 dark:text-red-800">Login failed, check your login detail</span>' .
  '<button @click="alertLogin = false" type="button" class="ml-2 -mx-1.5 -my-1.5 bg-red-100 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8 dark:bg-red-200 dark:text-red-600 dark:hover:bg-red-300" data-dismiss-target="#alert-2" aria-label="Close">' .
